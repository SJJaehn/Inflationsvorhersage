...
if MODE == "single":
    ...
    for j, name in enumerate(pred_names):
        ...
        rows.append(dict(
            Predictor=name, OOS_Beg=beg, OOS_End=end, Num_OOS_Obs=int(valid.sum()),
    ...
    print("\n========== Summary ==========")
    print(tbl[["Predictor", "R2_OOS", "R2_OOS_CT", "CW_p", "CW_p_CT",
               "RMSE", "MAE", "Cor"]].to_string(index=False))
...
# =========================================================================
    ...
    summary = {
        ...
        "TrainObs": TRAIN_OBS, "TimeLag": TIME_LAG,
        "NumPredictors": len(used_names), "Predictors": "; ".join(used_names),
        ...
        "HitRate": fq["HitRate"], "R2_MZ": fq["MZ_R2"],
        "F_MZ": fq["MZ_F"], "p_MZ": fq["MZ_p"],
    }
