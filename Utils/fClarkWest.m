function [dTestStat, dPval] = fClarkWest(mY, mYhat1, mYhat2)
% Function for performing the modified Clark-West (2007) test
...
% Calculate the squared residuals and squared prediction differences
mSqResid1 = (mY - mYhat1).^2;
mSqResid2 = (mY - mYhat2).^2;
mAdj      = (mYhat1 - mYhat2).^2;
    
% Calculate average difference of squared errors
vErrorDiff = mean( (mSqResid1 - ( mSqResid2 - mAdj) ) , 2, 'omitnan');
...
% Calculate p-value
dPval = 1 - tcdf(dTestStat,df);            % one-sided
end